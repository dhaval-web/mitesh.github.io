<%@ Page Language="VB" AutoEventWireup="false" CodeFile="trainerlogin.aspx.vb" Inherits="trainerlogin" %>
...
<body>
    ...
    <title>Trainer Login Form</title>
     <style type="text/css">
        #form1
        {
            height: 493px;
     ...
     <h1 class="style1" style="background-color: #333333; color: white;" 
                ...
                <br />
    <form id="form2" runat="server" class="h1" xml:lang="ae">
  
    <div class="style3" style="bottom: 7px">
     Trainer Login Form<asp:Panel ID="Panel1" runat="server" 
            Height="416px" BackImageUrl="~/images/login.jpg" 
        style="margin-left: 273px; margin-top: 75px; text-align: center;" 
        Width="779px" BorderStyle="Solid">
